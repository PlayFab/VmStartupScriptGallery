...
| [Linux metrics with Telegraf and PlayFab Insights](linux_metrics_telegraf_playfab_insights) | This script installs and configures [Telegraf](https://github.com/influxdata/telegraf) to send VM performance metrics (CPU/memory/disk/network) to [PlayFab Insights](https://learn.microsoft.com/en-us/gaming/playfab/features/insights/). |
